...
class Console:
    ...
    def __add_student(self):
        first_name = raw_input('Insert student first name: ')
        last_name = raw_input('Insert student last name: ')
        email = raw_input('Insert student email: ')
        try:
    ...
    def __delete_student(self):
        while True:
            try:
                student_id = int(raw_input('Insert student id you want to delete: '))
                break
            except:
    ...
    def __update_student(self):
        student_id = int(raw_input('Insert student id you want to update: '))
        first_name = raw_input('Insert student new first name (leave blank to not modify): ')
        last_name = raw_input('Insert student new last name (leave blank to not modify): ')
        email = raw_input('Insert student new email (leave blank to not modify): ')
        try:
    ...
    def __add_subject(self):
        id = raw_input('Insert subject code: ')
        name = raw_input('Insert subject name: ')
        try:
    ...
    def __delete_subject(self):
        ...
        subject_id = raw_input('Insert subject id you want tot delete: ')
        try:
    ...
    def __update_subject(self):
        subject_id = raw_input('Insert subject id you want to update: ')
        name = raw_input('Insert new subject name: ')
        if not name:
    ...
    def __add_grade(self):
        while True:
            try:
                student_id = int(raw_input('Insert student id you want to add the grade: '))
                subject_id = raw_input('Insert subject id you want to add the grade: ')
                break
            except:
                print('Student id must be integer!\n')
        while True:
            try:
                value = float(raw_input('Insert the grade: '))
                break
            except:
    ...
    def __update_grade(self):
        while True:
            try:
                grade_id = int(raw_input('Insert grade id for the grade you want tot update: '))
                value = float(raw_input('Insert the new grade: '))
                break
            except:
    ...
    def __show_students(self):
        ...
        for elem in data:
            s = json.loads(elem)
            print('Id: ', str(s['id']), ', first name: ', str(s['first_name']),
                  ', last name: ', str(s['last_name']), ', email: ', str(s['email']))
        print('\n')
    ...
    def __show_subjects(self):
        ...
        for elem in data:
            s = json.loads(elem)
            print('Id: ', str(s['id']), ', name: ', str(s['name']))
        print('\n')
